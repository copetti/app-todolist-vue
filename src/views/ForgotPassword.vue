                    ...
                    <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6">
                                ...
                                >
                                    <svg v-if="spinner.forgot_password"
                                         aria-hidden="true"
                                         role="status"
...
export default {
    ...
    methods:{
        forgotPassword(){
            ...
            axios.post('http://127.0.0.1:8000/api/v1/forgot-password', { email : this.email }).then(()=>{
                this.response.color = 'green';
                this.response.message = message['RecoveryEmailSucceeded'];
                this.resetForm();
            }).catch((e)=>{
